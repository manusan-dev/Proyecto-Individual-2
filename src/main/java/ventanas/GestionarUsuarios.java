...
public class GestionarUsuarios extends javax.swing.JFrame {
    ...
    public GestionarUsuarios() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al mostrar la información, por favor contacte al Administrador.");
        }
    ...
    private void initComponents() {
        ...
        jTable_usuarios.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        jTable_usuarios.setIntercellSpacing(new java.awt.Dimension(1, 1));
        jTable_usuarios.setMinimumSize(new java.awt.Dimension(60, 64));
        jScrollPane1.setViewportView(jTable_usuarios);
