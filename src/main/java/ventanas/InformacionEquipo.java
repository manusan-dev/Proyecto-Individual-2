...
public class InformacionEquipo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextPane_comentariosTecnico.setFocusable(false);
        ...
        if (observaciones.equals("")) {
         ...
         if (validacion == 0) {
             ...
             try {
                 ...
                 Connection cn = Conexion.conectar();
                 PreparedStatement pst = cn.prepareStatement(
                    "update equipos set modelo =?, num_serie =?, observaciones =?, status =?, tipo_equipo =?, marca =?, ultima_modificacion =?"
                            + " where id_equipo =?");
                 
                 pst.setString(1, modelo);
                 pst.setString(2, num_serie);
                 pst.setString(3, observaciones);
                 pst.setString(4, status);
                 pst.setString(5, tipo_equipo);
                 ...
                 cmb_status.setBackground(Color.GREEN);
